...
export default function StudentProfile() {
  ...
  const [profile, setProfile] = useState<StudentProfile>({
    ...
    bio: 'Passionate computer science student with a strong interest in web development and software engineering. Looking for internship opportunities to apply my skills and learn from industry professionals.',
  });
